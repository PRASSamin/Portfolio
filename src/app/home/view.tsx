...
const HomeView = ({ totalProjects, projects }: Props) => {
  return (
    <div
      className={`${poppins.className} flex flex-col items-center w-[calc(100vw-2rem)] lg:container mx-auto`}
    >
      <HeroSection />
      <div className="flex flex-col gap-28 w-full">
        ...
        <div className="flex flex-col gap-10 items-center">
          <div className="flex flex-col items-center ">
            <h2 className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-t from-[#000000] to-[#979797] dark:from-[#353535] dark:to-[#ffffff] leading-normal">
              Projects
            </h2>
